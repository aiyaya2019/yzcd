<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"D:\phpStudy\PHPTutorial\WWW\yzcd\public/../application/admin\view\repair\save.html";i:1572424290;s:72:"D:\phpStudy\PHPTutorial\WWW\yzcd\application\admin\view\common\meta.html";i:1552356108;s:72:"D:\phpStudy\PHPTutorial\WWW\yzcd\application\admin\view\common\edit.html";i:1546750684;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">编辑联保时长/年</label>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" value="<?php echo $list['title']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入商品名称" class="layui-input" readonly="readonly">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">预付款</label>
                    <div class="layui-input-block">
                        <input type="text" name="front_money" value="<?php echo $list['front_money']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入预付款" class="layui-input" readonly="readonly">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">市场价</label>
                    <div class="layui-input-block">
                        <input type="text" name="money" value="<?php echo $list['money']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入市场价" class="layui-input" readonly="readonly">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">可得积分</label>
                    <div class="layui-input-block">
                        <input type="text" name="point" value="<?php echo $list['point']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入可得积分" class="layui-input" readonly="readonly">
                    </div>
                </div>
