<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpStudy\PHPTutorial\WWW\yzcd\public/../application/admin\view\cash\shop_cash.html";i:1572859760;s:72:"D:\phpStudy\PHPTutorial\WWW\yzcd\application\admin\view\common\meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table','form'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Cash/shop_cash'); ?>";
...
{{# if (d.type === 4) { }}
    <div class="layui-btn layui-btn-xs" onclick="shopExamine('{{d.id}}', 5)">同意</div>
    <div class="layui-btn layui-btn-xs" onclick="shopExamine('{{d.id}}', 6)">拒绝</div>
{{# } }}
</script>
...
<script>
    function shopExamine(id, type){
        var data = {
            id:id,
            type:type
        };
        get_request("<?php echo url('Cash/shopExamine'); ?>", data);
    }
</script>