<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"D:\phpStudy\PHPTutorial\WWW\yzcd\public/../application/admin\view\activity\coupon_act_save.html";i:1568715308;s:72:"D:\phpStudy\PHPTutorial\WWW\yzcd\application\admin\view\common\meta.html";i:1552356108;s:72:"D:\phpStudy\PHPTutorial\WWW\yzcd\application\admin\view\common\edit.html";i:1546750684;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" value="<?php echo $list['title']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div style="margin-top:10px" id="video_val">
                        <img src="<?php echo $list['pic']; ?>" style="width:200px" id="pic" />
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入" lay-verify="required" name="descs" class="layui-textarea"><?php echo $list['descs']; ?></textarea>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入详情" lay-verify="required" name="content" class="layui-textarea edit"><?php echo $list['content']; ?></textarea>
                    </div>
                </div>
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Activity/coupon_act_save'); ?>",function(data){
        if(data.code == 200){
            if(data.data != ''){
