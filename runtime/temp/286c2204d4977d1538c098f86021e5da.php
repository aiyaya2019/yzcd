<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\phpStudy\PHPTutorial\WWW\yzcd\public/../application/admin\view\reserves\index.html";i:1572858934;s:72:"D:\phpStudy\PHPTutorial\WWW\yzcd\application\admin\view\common\meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name="keywords" placeholder="请输入预约单号/姓名/手机号" autocomplete="off" class="layui-input">
                            </div>
                        </div>
...
<script>
    layui.use(['table','form'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Reserves/index'); ?>";
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Reserves/save'); ?>?id={{d.id}}">编辑</a>


{{# if (d.status=== 4) { }}
    <a class="layui-btn layui-btn-xs open" width="35%" height="50%" data-title="退款审核" url="<?php echo url('Reserves/refund'); ?>?id={{d.id}}">退款审核</a>
{{# } }}



  <!-- <a class="layui-btn layui-btn-danger layui-btn-xs delete" data-table="" data-id="{{d.id}}" lay-event="del">删除</a> -->
</script>
<!-- 
<script type="text/html" id="add">
  <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Reserves/reserve_save'); ?>">发布广告</a>
</script> -->
...
<script>
    function update(id,type){
        ...
        get_request("<?php echo url('Reserves/reserveExamine'); ?>",data);
    }
    function refund(id,status){
        ...
        get_request("<?php echo url('Reserves/refund'); ?>",data);
    }
</script>
